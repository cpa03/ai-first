...
- Old version specifications
- Completed project phase documentation
- Historical meeting notes and decisions

### What NOT to Archive

- Active documentation (belongs in parent docs/ directory)
...
Example: `2025-01-15_old-api-design_archived.md`
