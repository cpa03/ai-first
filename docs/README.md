...
| `npm run build:check`               | Build with environment validation                       |
...
| `npm run test:all`                  | Run all test suites (comprehensive + integration + e2e) |
...
| `npm run audit:ci`                  | Run npm audit (high severity)                           |
| `npm run audit:fix`                 | Auto-fix npm audit issues                               |
...
| `npm run deploy:cloudflare:staging` | Deploy to Cloudflare staging                            |
| `npm run docs:check-links`          | Validate documentation links                            |
| `npm run user-stories:validate`     | Validate user story files                               |
...
- [Modular Architecture Review](./audit/modular-architecture-review.md) - Modular architecture analysis and recommendations
...
- [Flexy Modularization Status - 2026-07-11](./audit/2026-07-11-flexy-modularity-status.md) - Code modularization status
...
Older audit reports are archived in [audit/archive/](./audit/archive/).

## Maintenance Reports

- [Repository Audit Report - 2026-07-15 (Latest)](./maintenance/2026-07-15-repository-audit.md) - Comprehensive repository audit
- [Repository Health Report - 2026-07-14](./maintenance/2026-07-14-repo-health-report.md) - Repository health analysis
- [Stale Branches Report - 2026-07-14](./maintenance/2026-07-14-stale-branches-report.md) - Stale branches analysis
