...
| ----------------------------------- | ----- | ----------------- |
| Active branches (<7 days)           | 30    | Keep              |
| Stale unmerged branches (7-14 days) | 25    | Review and decide |
| Very stale unmerged (>14 days)      | 1     | Close or update   |
| Total remote branches (excl main)   | 56    | —                 |
...
| -------------------------------------------------------------------- | ----------- | ------ |
| `origin/bolt/memoize-platform-detection-7847075536831248981`         | 2026-07-04  | 0 days |
| `origin/fix/1816-consolidate-database-migrations`                    | 2026-07-04  | 0 days |
| `origin/palette/adaptive-ripple-color`                               | 2026-07-04  | 0 days |
| `origin/repokeeper/maintenance-session-20260704-repohealth`          | 2026-07-04  | 0 days |
| `origin/sentinel/fix-supabase-filter-injection-16616913367529283454` | 2026-07-04  | 0 days |
...
| `origin/sentinel/sanitize-task-updates-10934618272305624147`         | 2026-07-03  | 1 day  |
...
## Stale Unmerged Branches (7-14 days old)
...
1. **Review stale branches** - Decide on the 25 stale unmerged branches (7-14 days old)
2. **Close very stale branches** - The 1 branch older than 14 days should be closed or updated
...
These branches appear to be duplicates or superseded by more recent work:

- `origin/repokeeper/maintenance-session-5`, `8`, `9`, `10` - Old maintenance sessions, consider closing
- `origin/brocula/browser-console-fixes-20260626-074143`, `20260627-204812`, `20260628-1657` - Iterative fixes, review if latest supersedes earlier ones
- `origin/flexy/modularize-hardcoded-strings`, `20260628-165545`, `20260628-074401` - Iterative modularization, review if latest supersedes earlier ones
...
_This report was generated by RepoKeeper maintenance session 20260704-1400_
