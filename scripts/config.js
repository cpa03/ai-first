...
const LIGHTHOUSE_CONFIG = {
  ...
  CHROME_PATH: (() => {
    ...
    const fallbackPaths = [
      ...
      '/Users/runner/.cache/ms-playwright/chromium-1234/chrome-mac/Chromium.app/Contents/MacOS/Chromium',
      ...
      'C:\\Users\\runneradmin\\.cache\\ms-playwright\\chromium-1234\\chrome-win\\chrome.exe',
  ...
  PAGES: getEnvString('LIGHTHOUSE_PAGES', '/,/login,/signup').split(','),
  AUTH_PAGES: getEnvString(
    'LIGHTHOUSE_AUTH_PAGES',
