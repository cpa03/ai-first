#!/usr/bin/env node
/**
 * BroCula Console Scanner - Firefox Version
 * Scans all pages for console errors and warnings using Firefox
 */
...
async function main() {
  console.log('🧛 BroCula Console Scanner Starting (Firefox)...');
  ...
  try {
    ...
    console.error(`❌ Failed to launch Firefox: ${launchError.message}`);
