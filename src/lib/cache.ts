...
export class Cache<T = unknown> {
  ...
  private slidingThreshold: number | null;
  ...
  constructor(options: CacheOptions = {}) {
    ...
    // Avoids redundant conditional logic, property lookups, and arithmetic on every cache read (get/has).
  ...
  get(key: string): T | null {
    ...
    // Uses pre-calculated threshold computed once in constructor.
    if (
      this.slidingThreshold !== null &&
