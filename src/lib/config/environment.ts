...
export const ENV_CONFIG = {
  ...
  CACHE: CACHE_CONFIG,
  UI: UI_ENV_CONFIG,
  VALIDATION: VALIDATION_ENV_CONFIG,
  AI: AI_ENV_CONFIG,
  RESILIENCE: RESILIENCE_ENV_CONFIG,
  AGENT: AGENT_ENV_CONFIG,
  SECURITY: SECURITY_ENV_CONFIG,
} as const;
