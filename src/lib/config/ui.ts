...
export const UI_CONFIG = {
  ...
  ANIMATION: {
    ...
    EASING: {
      ...
      SPINNER: 'cubic-bezier(0.4, 0, 0.6, 1)',
    },
  },
...
export const TOAST_CONFIG = {
  DURATION: {
    ...
    SHORT: EnvLoader.number('UI_TOAST_SHORT_DURATION_MS', 3000, 500, 10000),
    /** Env: UI_TOAST_NORMAL_DURATION_MS (default: 5000) */
    NORMAL: EnvLoader.number('UI_TOAST_NORMAL_DURATION_MS', 5000, 1000, 30000),
    /** Env: UI_TOAST_LONG_DURATION_MS (default: 8000) */
    LONG: EnvLoader.number('UI_TOAST_LONG_DURATION_MS', 8000, 2000, 60000),
  },
