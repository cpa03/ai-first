...
export const PROGRESS_STEPPER_LABELS = {
  ...
  /** Live screen reader announcement on step change */
  STEP_ANNOUNCEMENT: (current: number, total: number, label: string) =>
...
export const IDEA_INPUT_LABELS = {
  ...
  /** Help text paste shortcut hint - platform-aware */
  HELP_TEXT_PASTE_HINT: (isMac: boolean) =>
 ...
 */
/**
 * CapsLockWarning Labels
 * Eliminates hardcoded strings in CapsLockWarning component
 */
export const CAPS_LOCK_WARNING_LABELS = {
  /** Warning text displayed when Caps Lock is enabled */
