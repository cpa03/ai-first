...
// Grouped pattern objects retained verbatim from the pre-split
// remaining-hardcoded-patterns.ts so no existing export is dropped.
/**
...
export const REMAINING_PATTERNS = {
  ...
  LOADING_SPINNER_ELAPSED_TEXT: 'text-xs text-gray-600 font-mono',
