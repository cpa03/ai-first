...
export function generateErrorFingerprint(
  ...
  // SECURITY: Use a stable hash for fingerprinting that works across runtimes.
  // DJB2 (simpleHash) is deterministic and safe for this non-cryptographic use case.
  // simpleHash returns an 8-char hex string.
