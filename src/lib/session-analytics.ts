...
function flushEvents(): void {
  ...
  // Use logger.debug instead of console.log to prevent data leakage and satisfy audits.
  // This information can be extended to PostHog or other analytics providers later.
  if (process.env.NODE_ENV !== 'production') {
    logger.debug('[SessionAnalytics] Events:', JSON.stringify(eventsToSend, null, 2));
  }
