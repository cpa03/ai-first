...
export function generateId(): string {
  ...
  // We use a range that yields 9 base36 characters to match original entropy (36^9).
  const randomPart = Math.floor(secureRandom() * 101559956668416).toString(36).padStart(9, '0');
