...
/**
 * PERFORMANCE & SECURITY: Lazily initialize ADMIN_API_KEY to avoid top-level side effects
 * and process.env access during Cloudflare Workers build/scanning phase.
 */
