 ...
 *
 * NOTE: Initialized lazily to ensure module side-effect freedom for Edge/Workers builds.
 */
let dateFormattingCache: Map<string, Intl.DateTimeFormat> | null = null;
...
function getCachedFormatter(
  ...
  if (!dateFormattingCache) {
    dateFormattingCache = new Map();
  }
