  ...
  return (
    <div className={PAGE_LAYOUT_CLASSES.CONTAINER_MD}>
      ...
      <div className="flex justify-between items-center mb-8">
        <Skeleton className="h-9 w-48" variant="text" showDelay={300} />
        <Skeleton
      ...
      <div className={`${CARD_PATTERNS.CENTERED} space-y-4`}>
        <Skeleton className="h-6 w-1/3" variant="text" showDelay={300} />
        <Skeleton className="h-4 w-full" variant="text" showDelay={300} />
        <Skeleton className="h-4 w-5/6" variant="text" showDelay={300} />
        <Skeleton className="h-4 w-4/6" variant="text" showDelay={300} />
        <Skeleton className="h-px w-full" variant="rect" showDelay={300} />
        <Skeleton className="h-4 w-3/4" variant="text" showDelay={300} />
        <Skeleton className="h-4 w-2/3" variant="text" showDelay={300} />
      </div>

      {/* Task management skeleton */}
      <div className="mt-8 space-y-4">
        <Skeleton className="h-6 w-40" variant="text" showDelay={300} />
      ...
      <div className="mt-8">
        <Skeleton className="h-7 w-40 mb-6" variant="text" showDelay={300} />
