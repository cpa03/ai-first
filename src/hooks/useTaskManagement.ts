 ...
 * PERFORMANCE: Moved outside hook to ensure it has a static identity.
 */
...
export function useTaskManagement(ideaId: string): UseTaskManagementReturn {
  ...
  // PERFORMANCE: Update ref in useEffect to avoid render-phase side effects
  useEffect(() => {
  ...
  // PERFORMANCE: Uses dataRef to maintain a stable callback identity
