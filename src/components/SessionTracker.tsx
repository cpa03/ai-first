 ...
 *
 * PERFORMANCE: Wrapped in React.memo to completely prevent unnecessary re-renders
 * when parent components update, avoiding redundant executions of the useSessionDuration hook.
 */
...
const SessionTracker = memo(SessionTrackerComponent);
