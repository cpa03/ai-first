...
const toastColors = {
  success: {
    container: `${TOAST_CONFIG.STYLES.SUCCESS.BG} ${TOAST_CONFIG.STYLES.SUCCESS.BORDER} ${TOAST_CONFIG.STYLES.SUCCESS.LEFT_BORDER}`,
  ...
  error: {
    container: `${TOAST_CONFIG.STYLES.ERROR.BG} ${TOAST_CONFIG.STYLES.ERROR.BORDER} ${TOAST_CONFIG.STYLES.ERROR.LEFT_BORDER}`,
  ...
  warning: {
    container: `${TOAST_CONFIG.STYLES.WARNING.BG} ${TOAST_CONFIG.STYLES.WARNING.BORDER} ${TOAST_CONFIG.STYLES.WARNING.LEFT_BORDER}`,
  ...
  info: {
    container: `${TOAST_CONFIG.STYLES.INFO.BG} ${TOAST_CONFIG.STYLES.INFO.BORDER} ${TOAST_CONFIG.STYLES.INFO.LEFT_BORDER}`,
...
function ToastComponent({ toast, onClose }: ToastProps) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={handleClose}
        className={`flex-shrink-0 ${ML_CLASSES.MD} ${styles.textColor} hover:opacity-75 ${FOCUS_RING_OFFSET_PATTERNS.FOCUS} rounded-md ${P_CLASSES.SM} ${MIN_SIZE_CLASSES.TOAST_BUTTON} transition-opacity`}
