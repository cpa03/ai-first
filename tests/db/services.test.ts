...
const createMockSupabaseClient = (): MockSupabaseChain => {
  const chain: MockSupabaseChain = {
    ...
    single: jest
      .fn()
      .mockResolvedValue({ data: null, count: null, error: null }),
    eq: jest.fn(),
    is: jest.fn(),
    order: jest.fn(),
    update: jest.fn(),
  ...
  describe('VectorService', () => {
    ...
    describe('getVectorsPaginated', () => {
      it('should return paginated vectors with total count', async () => {
        ...
        const result = await vectorService.getVectorsPaginated(
          'idea-1',
          'context',
          {
            page: 1,
  ...
  describe('ClarificationService', () => {
    ...
    describe('getAgentLogsPaginated', () => {
      it('should return paginated agent logs with total count', async () => {
        ...
        const result = await clarificationService.getAgentLogsPaginated(
          'test-agent',
          {
            page: 1,
            pageSize: 10,
