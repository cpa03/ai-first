...
## 2026-02-19 - Improved Accessibility for CopyButton
**Learning:** Fixed ARIA label consistency in CopyButton to ensure screen readers announce the correct success message when copying is complete.
**Action:** Updated `aria-label` to use `successLabel` when `copied` is true.
