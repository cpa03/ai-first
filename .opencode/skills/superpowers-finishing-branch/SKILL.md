...
**Announce at start:** "I am using the superpowers-finishing-branch skill to complete this work."
...
- **superpowers-subagent-dev** - After all tasks complete
- **superpowers-executing-plans** - After all batches complete

**Pairs with:**

- **superpowers-git-worktrees** - Cleans up worktree created by that skill
